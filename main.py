...
axs[0].hist(df_medians, bins=30, density=True, color='skyblue', edgecolor = 'black')
axs[0].set_title('Median histogram')
axs[0].set_xlabel("Prices")
axs[0].set_ylabel("Proportion")

axs[1].hist(df['SalePrice'], bins=30, density=True, color ='skyblue', edgecolor = 'black')
axs[1].set_title('Population histogram')
axs[1].set_xlabel("Prices")
axs[1].set_ylabel("Proportion")

axs[2].hist(price_samp['SalePrice'], bins=10, density=True, color ='skyblue', edgecolor = 'black')
